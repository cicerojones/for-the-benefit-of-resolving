...
1. make sure you where/what branch you have checked out
2. make, stage and commit changes on a local branch
3. in magit, you will not see a remote for this local branch
4. so, switch to the master branch (checkout master)
   1. you may encounter errors if you haven't staged/committed things!
